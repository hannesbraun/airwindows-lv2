...
static void activate(LV2_Handle instance)
{
	...
	for (int x = 0; x < 15; x++) {xBandpass->biquad[x] = 0.0; xBandpass->biquadA[x] = 0.0; xBandpass->biquadB[x] = 0.0; xBandpass->biquadC[x] = 0.0; xBandpass->biquadD[x] = 0.0;}
	xBandpass->fpdL = 1.0; while (xBandpass->fpdL < 16386) xBandpass->fpdL = rand()*UINT32_MAX;
	xBandpass->fpdR = 1.0; while (xBandpass->fpdR < 16386) xBandpass->fpdR = rand()*UINT32_MAX;
}
...
static void run(LV2_Handle instance, uint32_t sampleFrames)
{
	...
	for (int x = 0; x < 7; x++) {xBandpass->biquad[x] = xBandpass->biquadD[x] = xBandpass->biquadC[x] = xBandpass->biquadB[x] = xBandpass->biquadA[x];}
	...
	while (sampleFrames-- > 0) {
		...
		xBandpass->biquad[8] = xBandpass->biquad[7]; xBandpass->biquad[7] = inputSampleL; xBandpass->biquad[10] = xBandpass->biquad[9];
		...
		xBandpass->biquad[12] = xBandpass->biquad[11]; xBandpass->biquad[11] = inputSampleR; xBandpass->biquad[14] = xBandpass->biquad[13];
		if (outSample > 1.57079633) outSample = 1.57079633;
		if (outSample < -1.57079633) outSample = -1.57079633;
		...
		if (aWet > 0.0) {
			...
			xBandpass->biquadA[8] = xBandpass->biquadA[7]; xBandpass->biquadA[7] = inputSampleL; xBandpass->biquadA[10] = xBandpass->biquadA[9];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
			...
			xBandpass->biquadA[12] = xBandpass->biquadA[11]; xBandpass->biquadA[11] = inputSampleR; xBandpass->biquadA[14] = xBandpass->biquadA[13];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
		...
		if (bWet > 0.0) {
			...
			xBandpass->biquadB[8] = xBandpass->biquadB[7]; xBandpass->biquadB[7] = inputSampleL; xBandpass->biquadB[10] = xBandpass->biquadB[9];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
			...
			xBandpass->biquadB[12] = xBandpass->biquadB[11]; xBandpass->biquadB[11] = inputSampleR; xBandpass->biquadB[14] = xBandpass->biquadB[13];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
		...
		if (cWet > 0.0) {
			...
			xBandpass->biquadC[8] = xBandpass->biquadC[7]; xBandpass->biquadC[7] = inputSampleL; xBandpass->biquadC[10] = xBandpass->biquadC[9];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
			...
			xBandpass->biquadC[12] = xBandpass->biquadC[11]; xBandpass->biquadC[11] = inputSampleR; xBandpass->biquadC[14] = xBandpass->biquadC[13];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
		...
		if (dWet > 0.0) {
			...
			xBandpass->biquadD[8] = xBandpass->biquadD[7]; xBandpass->biquadD[7] = inputSampleL; xBandpass->biquadD[10] = xBandpass->biquadD[9];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
			...
			xBandpass->biquadD[12] = xBandpass->biquadD[11]; xBandpass->biquadD[11] = inputSampleR; xBandpass->biquadD[14] = xBandpass->biquadD[13];
			if (outSample > 1.57079633) outSample = 1.57079633;
			if (outSample < -1.57079633) outSample = -1.57079633;
		...
		xBandpass->fpdL ^= xBandpass->fpdL << 13; xBandpass->fpdL ^= xBandpass->fpdL >> 17; xBandpass->fpdL ^= xBandpass->fpdL << 5;
		inputSampleL += (((double)xBandpass->fpdL-(uint32_t)0x7fffffff) * 5.5e-36l * pow(2,expon+62));
		frexpf((float)inputSampleR, &expon);
		xBandpass->fpdR ^= xBandpass->fpdR << 13; xBandpass->fpdR ^= xBandpass->fpdR >> 17; xBandpass->fpdR ^= xBandpass->fpdR << 5;
