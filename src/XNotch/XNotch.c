...
static void activate(LV2_Handle instance)
{
	...
	for (int x = 0; x < 15; x++) {xNotch->biquad[x] = 0.0; xNotch->biquadA[x] = 0.0; xNotch->biquadB[x] = 0.0; xNotch->biquadC[x] = 0.0; xNotch->biquadD[x] = 0.0;}
	xNotch->fpdL = 1.0; while (xNotch->fpdL < 16386) xNotch->fpdL = rand()*UINT32_MAX;
	xNotch->fpdR = 1.0; while (xNotch->fpdR < 16386) xNotch->fpdR = rand()*UINT32_MAX;
}
...
static void run(LV2_Handle instance, uint32_t sampleFrames)
{
	...
	for (int x = 0; x < 7; x++) {xNotch->biquad[x] = xNotch->biquadD[x] = xNotch->biquadC[x] = xNotch->biquadB[x] = xNotch->biquadA[x];}
	...
	while (sampleFrames-- > 0) {
		...
		xNotch->biquad[8] = xNotch->biquad[7]; xNotch->biquad[7] = inputSampleL; xNotch->biquad[10] = xNotch->biquad[9];
		...
		xNotch->biquad[12] = xNotch->biquad[11]; xNotch->biquad[11] = inputSampleR; xNotch->biquad[14] = xNotch->biquad[13];
		...
		if (aWet > 0.0) {
			...
			xNotch->biquadA[8] = xNotch->biquadA[7]; xNotch->biquadA[7] = inputSampleL; xNotch->biquadA[10] = xNotch->biquadA[9];
			...
			xNotch->biquadA[12] = xNotch->biquadA[11]; xNotch->biquadA[11] = inputSampleR; xNotch->biquadA[14] = xNotch->biquadA[13];
		...
		if (bWet > 0.0) {
			...
			xNotch->biquadB[8] = xNotch->biquadB[7]; xNotch->biquadB[7] = inputSampleL; xNotch->biquadB[10] = xNotch->biquadB[9];
			...
			xNotch->biquadB[12] = xNotch->biquadB[11]; xNotch->biquadB[11] = inputSampleR; xNotch->biquadB[14] = xNotch->biquadB[13];
		...
		if (cWet > 0.0) {
			...
			xNotch->biquadC[8] = xNotch->biquadC[7]; xNotch->biquadC[7] = inputSampleL; xNotch->biquadC[10] = xNotch->biquadC[9];
			...
			xNotch->biquadC[12] = xNotch->biquadC[11]; xNotch->biquadC[11] = inputSampleR; xNotch->biquadC[14] = xNotch->biquadC[13];
		...
		if (dWet > 0.0) {
			...
			xNotch->biquadD[8] = xNotch->biquadD[7]; xNotch->biquadD[7] = inputSampleL; xNotch->biquadD[10] = xNotch->biquadD[9];
			...
			xNotch->biquadD[12] = xNotch->biquadD[11]; xNotch->biquadD[11] = inputSampleR; xNotch->biquadD[14] = xNotch->biquadD[13];
		...
		xNotch->fpdL ^= xNotch->fpdL << 13; xNotch->fpdL ^= xNotch->fpdL >> 17; xNotch->fpdL ^= xNotch->fpdL << 5;
		inputSampleL += (((double)xNotch->fpdL-(uint32_t)0x7fffffff) * 5.5e-36l * pow(2,expon+62));
		frexpf((float)inputSampleR, &expon);
		xNotch->fpdR ^= xNotch->fpdR << 13; xNotch->fpdR ^= xNotch->fpdR >> 17; xNotch->fpdR ^= xNotch->fpdR << 5;
